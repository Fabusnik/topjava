...
public class MealsUtil {
    public static final List<Meal> MEALS = Arrays.asList(
            ...
            new Meal(1,LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак", 900),
            new Meal(1,LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед", 550),
            new Meal(1,LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин", 610)
    );
