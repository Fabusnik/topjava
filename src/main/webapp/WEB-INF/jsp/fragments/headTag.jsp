...
<head>
    ...
    <%--<link rel="stylesheet" href="webjars/bootstrap-datetimepicker.min.css" />--%>
    ...
    <script type="text/javascript" src="webjars/momentjs/2.18.1/min/moment-with-locales.min.js" defer></script>
